(function () {
  var t = t || {};
  this.Int32Array || ((this.Int32Array = Array), (this.Float32Array = Array)),
    (t.Mat3 = function (t) {
    ...
    (t.Mat3.prototype.solve = function (e, i) {
      ...
      if (
        ...
        (i.x =
          (a[0 * o + 3] - a[0 * o + 2] * i.z - a[0 * o + 1] * i.y) /
          a[0 * o + 0]),
        isNaN(i.x) ||
          isNaN(i.y) ||
          isNaN(i.z) ||
    ...
    (t.Mat3.prototype.reverse = function (e) {
      ...
      do {
        ...
        do {
          var p = o[a + n * s] / o[a + n * a];
          r = n;
          do (h = n - r), (o[h + n * s] = o[h + n * s] - o[h + n * a] * p);
          while (--r);
        } while (s--);
      } while (--a);
      a = 2;
    ...
    (t.Vec3.prototype.vadd = function (e, i) {
      return i
        ? ((i.x = e.x + this.x),
          ...
          (i.z = e.z + this.z),
          void 0)
        : new t.Vec3(this.x + e.x, this.y + e.y, this.z + e.z);
    }),
  ...
  (t.Vec3.prototype.tangents = function (t, n) {
    ...
    if (o > 0) {
      ...
      var r = i;
      0.9 > Math.abs(a.x)
        ? (r.set(1, 0, 0), a.cross(r, t))
        : (r.set(0, 1, 0), a.cross(r, t)),
        a.cross(t, n);
    ...
    (t.Quaternion.prototype.setFromVectors = function (t, e) {
      ...
      (this.x = i.x),
        ...
        (this.z = i.z),
        (this.w =
          Math.sqrt(Math.pow(t.norm(), 2) * Math.pow(e.norm(), 2)) + t.dot(e)),
        this.normalize();
    });
  var n = new t.Vec3(),
    o = new t.Vec3(),
  ...
  (t.Quaternion.prototype.mult = function (e, i) {
    ...
    (t.Quaternion.prototype.vmult = function (e, i) {
      if (((i = i || new t.Vec3()), 0 === this.w))
        (i.x = e.x), (i.y = e.y), (i.z = e.z);
      else {
        var n = e.x,
          o = e.y,
          a = e.z,
    ...
    (t.Quaternion.prototype.toEuler = function (t, e) {
      ...
      switch (e) {
        case 'YZX':
          ...
          if (
            (c > 0.499 &&
              ((i = 2 * Math.atan2(a, h)), (n = Math.PI / 2), (o = 0)),
            -0.499 > c &&
              ((i = -2 * Math.atan2(a, h)), (n = -Math.PI / 2), (o = 0)),
            isNaN(i))
          ) {
    ...
    (t.ObjectPool.prototype.constructObject = function () {
      throw Error(
        'constructObject() not implemented in this ObjectPool subclass yet!'
      );
    }),
    (t.Vec3Pool = function () {
    ...
    (t.Shape.prototype.getBoundingSphereRadius = function () {
      return (
        this.boundingSphereRadiusNeedsUpdate &&
    ...
    (t.Shape.prototype.calculateLocalInertia = function () {
      throw (
        'calculateLocalInertia() not implemented for shape type ' + this.type
      );
    });
  var s = new t.Vec3(),
    r = new t.Vec3();
  (t.Shape.prototype.calculateTransformedInertia = function (e, i, n) {
    ...
    var o = s,
      a = r;
    return (
      this.calculateLocalInertia(e, o),
      i.vmult(o, a),
      (n.x = Math.abs(a.x)),
      (n.y = Math.abs(a.y)),
      (n.z = Math.abs(a.z)),
    ...
    (t.Particle = function (e, i) {
      ...
      if (i !== void 0 && !(i instanceof t.Material))
        throw Error(
          'Argument 3 (material) must be an instance of CANNON.Material.'
        );
    ...
    (t.Particle.prototype.wakeUp = function () {
      ...
      (this.sleepState = 0), 2 === t && this.dispatchEvent({ type: 'wakeup' });
    }),
      ...
      if (this.allowSleep) {
        ...
        0 === e && n > i
          ...
          : 1 === e &&
            ...
            ((this.sleepState = 2), this.dispatchEvent({ type: 'sleep' }));
      }
    }),
  ...
  (t.SPHSystem.prototype.update = function () {
    ...
    for (var p = y, d = f, x = m, g = w, V = b, o = 0; o !== t; o++) {
      ...
      for (var E, S, s = this.neighbors[o], r = s.length, c = 0; c !== r; c++) {
        ...
        (E =
          -N.mass *
          (this.pressures[o] / (this.densities[o] * this.densities[o] + n) +
            this.pressures[c] / (this.densities[c] * this.densities[c] + n))),
          this.gradw(g, x),
          x.mult(E, x),
          p.vadd(x, p),
          N.velocity.vsub(z.velocity, V),
          V.mult(
            (1 / (1e-4 + this.densities[o] * this.densities[c])) *
              this.viscosity *
              N.mass,
            V
          ),
    ...
    (t.Box.prototype.calculateLocalInertia = function (e, i) {
      ...
      return (
        (i.x = (1 / 12) * e * (2 * 2 * n.y * n.y + 2 * 2 * n.z * n.z)),
  ...
  (t.Compound.prototype.calculateLocalInertia = function (e, i) {
    i = i || new t.Vec3();
    for (
      var n = this.volume(), o = z, a = 0, s = this.childShapes.length;
      a !== s;
      a++
    ) {
  ...
  (t.Compound.prototype.calculateWorldAABB = function (t, e, i, n) {
    ...
    (t.ConvexPolyhedron = function (e, i) {
      ...
      function o(t, e, i, n, o) {
        for (
          var a = t.vertices.length, s = null, r = null, h = t.vertices, c = 0;
          a > c;
          c++
        ) {
      ...
      for (var l = 0; this.faces.length > l; l++)
        for (var m = this.faces[l].length, w = m, u = 0; w > u; u++) {
          var b = (u + 1) % m,
            x = new t.Vec3();
          this.vertices[this.faces[l][u]].vsub(
            this.vertices[this.faces[l][b]],
            x
          ),
            x.normalize();
          for (var g = !1, f = 0; this.uniqueEdges.length > f; f++)
            if (
              this.uniqueEdges[f].almostEquals(x) ||
              this.uniqueEdges[f].almostEquals(x)
            ) {
              g = !0;
              break;
      ...
      this.findSeparatingAxis = function (t, e, i, n, o, a) {
        for (
          var s = 1 / 0, r = this, h = 0, c = r.faces.length, l = 0;
          c > l;
          l++
        ) {
      ...
      (this.clipFaceAgainstHull = function (e, i, n, o, a, r, h) {
        ...
        for (
          var c = this, l = [], u = o, p = l, d = -1, v = 1 / 0, y = 0;
          c.faces.length > y;
          y++
        ) {
        ...
        if (0 > d)
          return (
            console.log('--- did not find any closest face... ---'), void 0
          );
        var m = c.faces[d];
        m.connectedFaces = [];
        for (var w = 0; c.faces.length > w; w++)
          for (var b = 0; c.faces[w].length > b; b++)
            -1 !== m.indexOf(c.faces[w][b]) &&
              w !== d &&
              -1 === m.connectedFaces.indexOf(w) &&
              m.connectedFaces.push(w);
        u.length;
        ...
        for (var E = N - T.dot(i), w = 0; u.length > w; w++) {
          ...
          if ((a >= M && ('', (M = a)), r >= M)) {
            var P = u[w];
            if (0 >= M) {
              var q = { point: P, normal: T, depth: M };
              h.push(q);
            }
          }
        }
    ...
    (t.ConvexPolyhedron.prototype.computeWorldVertices = function (e, i) {
      ...
      for (var o = this.vertices, a = this.worldVertices, s = 0; s !== n; s++)
        i.vmult(o[s], a[s]), e.vadd(a[s], a[s]);
    ...
    (t.ConvexPolyhedron.prototype.computeWorldFaceNormals = function (e) {
      ...
      for (
        var n = this.faceNormals, o = this.worldFaceNormals, a = 0;
        a !== i;
        a++
      )
        e.vmult(n[a], o[a]);
  ...
  (t.ConvexPolyhedron.prototype.calculateWorldAABB = function (t, e, i, n) {
    for (
      var o, a, s, r, h, c, l = this.vertices.length, u = this.vertices, p = 0;
      l > p;
      p++
    ) {
      ...
      o > d.x || void 0 === o
        ? (o = d.x)
        : (d.x > r || void 0 === r) && (r = d.x),
        a > d.y || void 0 === a
          ? (a = d.y)
          : (d.y > h || void 0 === h) && (h = d.y),
        s > d.z || void 0 === s
          ? (s = d.z)
  ...
  (t.ConvexPolyhedron.prototype.pointIsInside = function (t) {
    ...
    (t.Cylinder = function (e, i, n, o) {
      var a = o,
        ...
        u = Math.cos,
        p = Math.sin;
      s.push(new t.Vec3(i * u(0), i * p(0), 0.5 * -n)),
        c.push(0),
        s.push(new t.Vec3(e * u(0), e * p(0), 0.5 * n)),
        l.push(1);
      for (var d = 0; a > d; d++) {
        var v = ((2 * Math.PI) / a) * (d + 1),
          y = ((2 * Math.PI) / a) * (d + 0.5);
        a - 1 > d
          ? (s.push(new t.Vec3(i * u(v), i * p(v), 0.5 * -n)),
            c.push(2 * d + 2),
            s.push(new t.Vec3(e * u(v), e * p(v), 0.5 * n)),
            l.push(2 * d + 3),
            r.push(new t.Vec3(u(y), p(y), 0)),
            h.push([2 * d + 2, 2 * d + 3, 2 * d + 1, 2 * d]))
          : (h.push([0, 1, 2 * d + 1, 2 * d]),
            r.push(new t.Vec3(u(y), p(y), 0)));
      }
    ...
    (t.Ray = function (e, i) {
      ...
      (this.intersectBody = function (e) {
        return e.shape instanceof t.ConvexPolyhedron
          ? this.intersectShape(e.shape, e.quaternion, e.position, e)
          : e.shape instanceof t.Box
          ? this.intersectShape(
              e.shape.convexPolyhedronRepresentation,
              e.quaternion,
              e.position,
              e
            )
          : (console.warn(
              'Ray intersection is this far only implemented for ConvexPolyhedron and Box shapes.'
            ),
            void 0);
      }),
        (this.intersectShape = function (e, i, p, d) {
          ...
          if (e instanceof t.ConvexPolyhedron) {
            ...
            for (
              var m, w, b = e.faces, x = e.vertices, g = e.faceNormals, V = 0;
              b.length > V;
              V++
            ) {
              var z = b[V],
              ...
              if (
                ...
                !(a > Math.abs(m)) && ((w = l.dot(c) / m), !(0 > w) && 0 > m))
              ) {
  ...
  (t.Broadphase.prototype.needBroadphaseCollision = function (e, i) {
    return 0 === (e.collisionFilterGroup & i.collisionFilterMask) ||
      0 === (i.collisionFilterGroup & e.collisionFilterMask)
      ? !1
      : (0 === (e.motionstate & B) && !e.isSleeping()) ||
        (0 === (i.motionstate & B) && !i.isSleeping())
      ? e.shape || i.shape
        ? e.shape instanceof t.Plane && i.shape instanceof t.Plane
          ? !1
          : !0
        : !1
      : !1;
  ...
  (t.Broadphase.prototype.doBoundingSphereBroadphase = function (e, i, n, o) {
    ...
    (t.Broadphase.prototype.doBoundingBoxBroadphase = function (e, i, n, o) {
      ...
      if (
        ...
        e.aabbmax.x < i.aabbmin.x ||
          e.aabbmax.y < i.aabbmin.y ||
          e.aabbmax.z < i.aabbmin.z ||
          e.aabbmin.x > i.aabbmax.x ||
          e.aabbmin.y > i.aabbmax.y ||
          e.aabbmin.z > i.aabbmax.z ||
          (n.push(e), o.push(i));
      else if (a || s) {
        var r = a ? i : e,
          h = a ? e : i;
        h.shape instanceof t.Plane,
          r.position.x < h.aabbmin.x ||
            r.position.y < h.aabbmin.y ||
            r.position.z < h.aabbmin.z ||
            r.position.x > h.aabbmax.x ||
            r.position.y > h.aabbmax.y ||
            r.position.z > h.aabbmax.z ||
            (n.push(e), o.push(i));
      } else;
    });
  var A = {},
    ...
    (t.NaiveBroadphase.prototype.collisionPairs = function (t, e, i) {
      ...
      for (n = 0; n !== h; n++)
        for (o = 0; o !== n; o++)
          (a = r[n]),
            (s = r[o]),
            this.needBroadphaseCollision(a, s) &&
              this.intersectionTest(a, s, e, i);
    }),
    ...
    for (var P = 0; P !== M; P++)
      for (var ee = N[P], H = 0, ie = ee.length; H !== ie; H++)
        for (var j = ee[H], Q = 0; Q !== H; Q++) {
          var ne = ee[Q];
          this.needBroadphaseCollision(j, ne) &&
            this.intersectionTest(j, ne, i, n);
        }
  ...
  (t.GSSolver.prototype.solve = function (t, e) {
    ...
    for (var x = 0; x !== d; x++) {
      var g = p[x];
      g.spookParamsNeedsUpdate &&
        (g.updateSpookParams(f), (g.spookParamsNeedsUpdate = !1)),
        (b[x] = 0),
        (w[x] = g.computeB(f)),
        (m[x] = 1 / g.computeC());
    }
  ...
  (t.SplitSolver.prototype.solve = function (e, i) {
    ...
    for (
      ...
      s.push({ body: r[p], children: [], eqs: [], visited: !1 });
    for (var p = 0; p !== l; p++) {
      var d = s[p];
      (d.body = r[p]),
        (d.children.length = 0),
    ...
    (t.ContactMaterial = function (t, e, i, n) {
      (this.id = -1),
        (this.materials = [t, e]),
        (this.friction = void 0 !== i ? Number(i) : 0.3),
        (this.restitution = void 0 !== n ? Number(n) : 0.3),
    ...
    (t.World = function () {
      t.EventTarget.apply(this),
        ...
        (this.defaultContactMaterial = new t.ContactMaterial(
    ...
    (t.World.prototype.getContactMaterial = function (e, i) {
      if (e instanceof t.Material && i instanceof t.Material) {
        ...
        return this.contactmaterials[
          this.mats2cmat[n + o * this.materials.length]
        ];
      }
    }),
    ...
    (t.World.prototype.collisionMatrixGet = function (t, e, i) {
      ...
      return (
        ...
        i === void 0 || i
          ...
          : this.collisionMatrixPrevious[t]
      );
    }),
    (t.World.prototype.collisionMatrixSet = function (t, e, i, n) {
      ...
      (t = ((t * (t + 1)) >> 1) + e - 1),
        n === void 0 || n
          ? (this.collisionMatrix[t] = i)
          : (this.collisionMatrixPrevious[t] = i);
    }),
    ...
    (t.World.prototype.add = function (e) {
      (e.id = this.id()),
        ...
        e instanceof t.RigidBody &&
          (e.angularVelocity.copy(e.initAngularVelocity),
    ...
    (t.World.prototype.remove = function (t) {
      ...
      this.collisionMatrixPrevious.length = this.collisionMatrix.length =
        (e * (e - 1)) >> 1;
    }),
    ...
    (t.World.prototype.addContactMaterial = function (t) {
      ...
      var e, i;
      t.materials[0].id > t.materials[1].id
        ? ((e = t.materials[0].id), (i = t.materials[1].id))
        : ((i = t.materials[0].id), (e = t.materials[1].id)),
  ...
  (t.World.prototype.step = function (e) {
    ...
    for (var j = 0; j !== P; j++) {
      var C = n[j],
        ...
        I = r.indexOf(B),
        R =
          this.getContactMaterial(V.material, B.material) ||
          this.defaultContactMaterial,
        O = R.friction;
      R.restitution;
      var A = te;
      A.set(
        B.position.x + C.rj.x - V.position.x - C.ri.x,
        B.position.y + C.rj.y - V.position.y - C.ri.y,
        B.position.z + C.rj.z - V.position.z - C.ri.z
      );
      var T = A.dot(C.ni);
      if (0 > T) {
        if (
          ((C.restitution = R.restitution),
          (C.penetration = T),
        ...
        this.collisionMatrixSet(g, I, 1, !0),
          this.collisionMatrixGet(g, I, !0) !==
            this.collisionMatrixGet(g, I, !1) &&
            ((Z.with = B),
            (Z.contact = C),
            V.dispatchEvent(Z),
            (Z.with = V),
    ...
    for (g = 0; g !== s; g++) {
      var ye = r[g];
      ye.inertiaWorldAutoUpdate &&
        ye.quaternion.vmult(ye.inertia, ye.inertiaWorld),
        ye.invInertiaWorldAutoUpdate &&
          ye.quaternion.vmult(ye.invInertia, ye.invInertiaWorld);
    }
    if (this.allowSleep) for (g = 0; g !== s; g++) r[g].sleepTick(this.time);
  }),
    (t.ContactGenerator = function () {
      ...
      function c(e, i, n, o, a, s, r, h, c) {
        for (
          var l = L, u = D, p = 0, d = 0, v = n.childShapes.length;
          d !== v;
          d++
        ) {
          var f = [],
        ...
        if (a && f) {
          if (a.type === S)
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.SPHERE and ' +
                    f.type +
                    ' not implemented yet.'
                );
            }
            ...
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.PLANE and ' +
                    f.type +
                    ' not implemented yet.'
                );
            }
            ...
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.BOX and ' +
                    f.type +
                    ' not implemented yet.'
                );
            }
            ...
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.COMPOUND and ' +
                    f.type +
                    ' not implemented yet.'
                );
            }
            ...
            switch (f.type) {
              ...
              default:
                console.warn(
                  'Collision between CANNON.Shape.types.CONVEXPOLYHEDRON and ' +
                    f.type +
                    ' not implemented yet.'
                );
            }
          ...
          switch (f.type) {
            ...
            default:
              console.warn(
                'Collision between CANNON.Particle and ' +
                  f.type +
                  ' not implemented yet.'
              );
          }
  ...
  (t.ContactEquation.prototype.computeB = function (t) {
    ...
    (t.ContactEquation.prototype.computeC = function () {
      var t = this.bi,
        ...
        h = this.invIj;
      return (
        r.vmult(i, this.biInvInertiaTimesRixn),
  ...
  (t.ContactEquation.prototype.addToWlambda = function (t) {
    ...
    a.mult(n * t, r),
      ...
      void 0 !== e.wlambda &&
        (this.biInvInertiaTimesRixn.mult(t, s), e.wlambda.vsub(s, e.wlambda)),
      void 0 !== i.wlambda &&
        (this.bjInvInertiaTimesRjxn.mult(t, s), i.wlambda.vadd(s, i.wlambda));
  }),
  ...
  (t.FrictionEquation.prototype.computeB = function (t) {
    ...
    (t.FrictionEquation.prototype.computeC = function () {
      var t = this.bi,
        ...
        h = this.invIj;
      return (
        r.vmult(i, this.biInvInertiaTimesRixt),
  ...
  (t.FrictionEquation.prototype.addToWlambda = function (t) {
    ...
    a.mult(n * t, s),
      ...
      r && (this.biInvInertiaTimesRixt.mult(t, s), r.vsub(s, r)),
      h && (this.bjInvInertiaTimesRjxt.mult(t, s), h.vadd(s, h));
  }),
    ...
    (t.RotationalEquation.prototype.computeC = function () {
      ...
      var o = this.eps,
        ...
        s = this.invIj;
      return (
        t.invInertia ? a.setTrace(t.invInertia) : a.identity(),
  ...
  (t.RotationalEquation.prototype.computeGWlambda = function () {
    var t = this.bi,
      ...
      i = 0;
    return (
      t.wlambda && (i += t.wlambda.dot(this.njxni)),
      ...
      (s.minForce = -o),
        ...
        (this.update = function () {
          i.position.vsub(e.position, s.ni),
            s.ni.normalize(),
            s.ni.mult(0.5 * n, s.ri),
            s.ni.mult(0.5 * -n, s.rj);
        });
    }),
    ...
    (t.RotationalMotorEquation.prototype.constructor =
      t.RotationalMotorEquation),
  ...
  (t.RotationalMotorEquation.prototype.computeGWlambda = function () {
    ...
    (t.HingeConstraint = function (e, i, n, o, a, s, r) {
      ...
      var h = this,
        c = (this.equations = [
          new t.RotationalEquation(e, o),
          new t.RotationalEquation(e, o),
          new t.ContactEquation(e, o),
          new t.ContactEquation(e, o),
          new t.ContactEquation(e, o),
        ]);
      ...
      (this.motorTargetVelocity = 0),
        ...
        (this.enableMotor = function () {
          g ||
            ((l = new t.RotationalMotorEquation(e, o, r)), c.push(l), (g = !0));
        }),
    ...
    (t.PointToPointConstraint = function (e, i, n, o, a) {
      ...
      var s = (this.equations = [
          new t.ContactEquation(e, n),
          new t.ContactEquation(e, n),
          new t.ContactEquation(e, n),
        ]),
        r = s[0],
